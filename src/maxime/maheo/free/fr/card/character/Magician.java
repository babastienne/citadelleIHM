...
public class Magician extends Character {
    ...
    public final void power(final Player player, final Player opponent) {
        ...
        System.out.println("2) Défausser x cartes et piocher x cartes ?");
            ...
            if (authorisedString.contains(response)) {
                if (response == 1) {
                    ...
                    do {
                        ...
                        index++;
                        System.out.println("Tapez le numéro de la carte pour la défausser ou \"n\" pour arreter.");
                        ...
                        if (StringUtils.isNumeric(choice2)) {
                            if (authorisedString2.contains(Integer.parseInt(choice2))) {
                                ...
                                System.out.println("Vous avez défausser " + cardToRemove + " mais vous avez eu " + newCard);
                            ...
                            finish = true;
                            System.out.println("Vous ne défausser plus de cartes.");
                        } else {
                            System.out.println("Vous avez tapé un mauvais caractère.");
                            this.power(player, opponent);
                        }
